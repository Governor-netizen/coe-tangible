...
export default function MotorScrolly() {
  ...
  return (
    <div className="relative h-screen w-full bg-[#050505] overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-end md:justify-center px-4 sm:px-8 pointer-events-none pb-20 sm:pb-32 md:pb-8">
        <AnimatePresence>
          <motion.div
            key={currentIndex}
            className="absolute text-center flex flex-col items-center px-2 sm:px-0 w-full max-w-5xl"
          >
            ...
            <motion.h2
              ...
              className={`text-3xl sm:text-5xl md:text-7xl lg:text-9xl font-bold tracking-tighter mb-2 sm:mb-4 font-headline uppercase [text-shadow:_0_1px_8px_rgba(0,0,0,0.5)] ${messages[currentIndex].color}`}
            >
            ...
            <motion.p
              ...
              className="text-white/80 text-sm sm:text-lg md:text-xl max-w-2xl font-serif-body mb-4 sm:mb-8 px-2 [text-shadow:_0_1px_6px_rgba(0,0,0,0.4)]"
            >
