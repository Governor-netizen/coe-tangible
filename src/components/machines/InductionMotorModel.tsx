...
export function InductionMotorModel({
  ...
  return (
    <group>
      ...
      <MachinePartMesh partId="housing" name={getPart('housing').name} color={getPart('housing').color} isSelected={selectedPart === 'housing'} isExploded={isExploded} explodeOffset={getPart('housing').explodeOffset} assemblyOrder={getPart('housing').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
      ...
      {/* 2. STATOR CORE */}
      <MachinePartMesh partId="statorCore" name={getPart('statorCore').name} color={getPart('statorCore').color} isSelected={selectedPart === 'statorCore'} isExploded={isExploded} explodeOffset={getPart('statorCore').explodeOffset} assemblyOrder={getPart('statorCore').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        <mesh castShadow receiveShadow>
      ...
      {/* 3. PHASE R WINDING */}
      <MachinePartMesh partId="phaseR" name={getPart('phaseR').name} color={getPart('phaseR').color} isSelected={selectedPart === 'phaseR'} isExploded={isExploded} explodeOffset={getPart('phaseR').explodeOffset} assemblyOrder={getPart('phaseR').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        {[-1.0, 1.0].map((y, i) => (
      ...
      {/* 4. PHASE Y WINDING */}
      <MachinePartMesh partId="phaseY" name={getPart('phaseY').name} color={getPart('phaseY').color} isSelected={selectedPart === 'phaseY'} isExploded={isExploded} explodeOffset={getPart('phaseY').explodeOffset} assemblyOrder={getPart('phaseY').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        {[-0.5, 0.5].map((y, i) => (
      ...
      {/* 5. PHASE B WINDING */}
      <MachinePartMesh partId="phaseB" name={getPart('phaseB').name} color={getPart('phaseB').color} isSelected={selectedPart === 'phaseB'} isExploded={isExploded} explodeOffset={getPart('phaseB').explodeOffset} assemblyOrder={getPart('phaseB').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        {[0, -0.0].map((y, i) => (
      ...
      <MachinePartMesh partId="rotor" name={getPart('rotor').name} color={getPart('rotor').color} isSelected={selectedPart === 'rotor'} isExploded={isExploded} explodeOffset={getPart('rotor').explodeOffset} assemblyOrder={getPart('rotor').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        <group ref={rotorRef}>
          <mesh castShadow receiveShadow>
      ...
      {/* 7. SHAFT */}
      <MachinePartMesh partId="shaft" name={getPart('shaft').name} color={getPart('shaft').color} isSelected={selectedPart === 'shaft'} isExploded={isExploded} explodeOffset={getPart('shaft').explodeOffset} assemblyOrder={getPart('shaft').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        <group ref={shaftRef}>
          <mesh castShadow receiveShadow>
      ...
      <MachinePartMesh partId="endShield" name={getPart('endShield').name} color={getPart('endShield').color} isSelected={selectedPart === 'endShield'} isExploded={isExploded} explodeOffset={getPart('endShield').explodeOffset} assemblyOrder={getPart('endShield').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        {[2.1, -2.1].map((y) => (
          <group key={y}>
      ...
      <MachinePartMesh partId="coolingFan" name={getPart('coolingFan').name} color={getPart('coolingFan').color} isSelected={selectedPart === 'coolingFan'} isExploded={isExploded} explodeOffset={getPart('coolingFan').explodeOffset} assemblyOrder={getPart('coolingFan').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
        <group ref={fanRef}>
          {/* Hub */}
      ...
      {/* 10. TERMINAL BOX */}
      <MachinePartMesh partId="terminalBox" name={getPart('terminalBox').name} color={getPart('terminalBox').color} isSelected={selectedPart === 'terminalBox'} isExploded={isExploded} explodeOffset={getPart('terminalBox').explodeOffset} assemblyOrder={getPart('terminalBox').assemblyOrder} onClick={onPartClick} showLabel={showLabels} explodeSpread={explodeSpread}>
