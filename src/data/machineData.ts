    ...
    parts: [
      {
        ...
        name: 'Stator',
        color: '#4A90A4',
        description: 'The stationary outer part containing three-phase windings distributed 120° apart.',
        function: 'Three-phase currents in the stator windings create a rotating magnetic field (RMF) at synchronous speed.',
        concepts: ['Rotating Magnetic Field', 'Three-Phase System', 'Synchronous Speed'],
        assemblyOrder: 1,
        explodeOffset: [0, 0, -1.5],
      },
      {
        id: 'phaseA',
        name: 'Phase A Winding',
        color: '#C94040',
        description: 'First phase winding carrying current at 0° phase angle. Part of the three-phase system.',
        function: 'Contributes one-third of the rotating magnetic field. Current leads Phase B by 120°.',
      ...
      },
      {
        ...
        color: '#D4A843',
        description: 'Second phase winding carrying current at 120° phase angle.',
        function: 'Contributes one-third of the rotating magnetic field, 120° displaced from Phase A.',
      ...
      {
        id: 'phaseC',
        name: 'Phase C Winding',
        color: '#4A8C5C',
        description: 'Third phase winding carrying current at 240° phase angle.',
      ...
      },
      {
        ...
        color: '#E8734A',
        description: 'Consists of conductor bars short-circuited by end rings, resembling a squirrel cage.',
      ...
      },
      {
        ...
        name: 'Shaft',
        color: '#999999',
        description: 'Transmits the rotational energy from the rotor to the mechanical load.',
